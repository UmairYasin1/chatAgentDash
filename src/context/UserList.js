                   ...
                   socket.emit('get_visitor_id', visitorAndAgentIdobj, function (response) 
                   {
                    //play()
                     ...
                     {     
                        ...
                        if(response.agent_name !== "ChatBot")
                        {
                          console.log('@@@@');
                        ...
                        else if(response.agent_name === "ChatBot")
                        {
                          console.log('!!!!!!!');
                          //socket.emit('update-room-unassigned',{ visitor_id : vis_id,  agent_id : 'tFAE3OWtP', agent : 'ChatBot' });
                          socket.emit('update-room',{ visitor_id : vis_id,  agent_id : 'tFAE3OWtP', agent : 'ChatBot', isVisitorList : true, page: 'UserList.js'});
